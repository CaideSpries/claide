...
TENANTS_DIR="tenants"
VERSION="${CLAIDE_VERSION:-0.1.0}"
ENV="${CLAIDE_ENV:-production}"
...
for dir in "$TENANTS_DIR"/*/; do
  ...
  tenant-$name:
    ...
    environment:
      - RUST_LOG=claide=info
      - RUST_LOG_FORMAT=json
      - CLAIDE_HEALTH_PORT=9090
    labels:
      com.claide.tenant: $name
      com.claide.version: "$VERSION"
      com.claide.env: "$ENV"
    healthcheck:
