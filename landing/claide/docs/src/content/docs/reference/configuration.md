---
title: Configuration
description: Claide configuration file reference
tableOfContents:
  minHeadingLevel: 2
  maxHeadingLevel: 3
---

Claide is configured via `~/.claide/config.json`. All fields have sensible defaults.
...
Run `claide config check` to validate your configuration. It reports:
