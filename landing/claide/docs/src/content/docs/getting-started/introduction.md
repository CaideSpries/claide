---
title: Introduction
description: What is Claide and why should you use it?
---

**Claide** is an ultra-lightweight personal AI assistant built in Rust. It packages streaming LLM responses, agent swarms, a plugin system, batch processing, 8 messaging channels, and container isolation into a single ~4MB binary.
...
```bash
# One-shot CLI mode
$ claide agent --stream -m "Summarize the last 5 git commits"
...
| Feature | Claide | LangChain | AutoGPT |
|---------|-----------|-----------|---------|
...
Ready to get started? [Install Claide](/docs/getting-started/installation/) and run your first agent in under a minute.
